...
class CoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    @enroll_success_flash_notice = %Q[You were successfully enrolled in #{@course.name}! View your invitation <a href="https://github.com/orgs/#{@course.course_organization}/invitation">here</a>.]
  end
